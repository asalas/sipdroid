...
public class Sipdroid extends Activity implements OnDismissListener {
    ...
    public static final int LOGIN_CONSOLE_VOIPMEDIA = FIRST_MENU_ID + 4;
    ...
    public void onCreate(Bundle icicle) {
        ...
        Button loginConsoleButton = (Button) findViewById(R.id.login_console);
        loginConsoleButton.setOnClickListener(new Button.OnClickListener()
        {
            public void onClick(View v)
            {
                Intent myIntent = new Intent(mContext, net.voipmedia.ui.LoginConsoleVoIPMedia.class);
                startActivity(myIntent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        m = menu.add(0, LOGIN_CONSOLE_VOIPMEDIA, 0, R.string.login_console);
        m.setIcon(android.R.drawable.ic_menu_preferences);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case LOGIN_CONSOLE_VOIPMEDIA:
            {
                try
                {
                    intent = new Intent(this, net.voipmedia.ui.LoginConsoleVoIPMedia.class);
                    startActivity(intent);
                }
                catch (ActivityNotFoundException e)
                {
